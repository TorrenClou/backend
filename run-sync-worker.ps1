# PowerShell script to run the TorreClou Sync Worker Docker container
# Usage: .\run-sync-worker.ps1
...
Write-Host "Starting TorreClou Sync Worker..." -ForegroundColor Green
